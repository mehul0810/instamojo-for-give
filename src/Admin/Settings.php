		...
		switch ( $current_section ) {
			case 'instamojo':
				$settings = [
					...
					[
						'name'    => esc_html__( 'Test - Client Id', 'instamojo-for-give' ),
						'desc'    => esc_html__( 'Please enter the client id from your TEST Instamojo Account.', 'instamojo-for-give' ),
						'id'      => 'mg_instamojo_get_test_client_id',
						'type'    => 'text',
						'default' => '',
					],
					[
						'name'    => esc_html__( 'Test - Client Secret', 'instamojo-for-give' ),
						'desc'    => esc_html__( 'Please enter the client secret from your TEST Instamojo Account.', 'instamojo-for-give' ),
						'id'      => 'mg_instamojo_get_test_client_secret',
						'type'    => 'text',
						'default' => '',
					],
					[
